...
def log_metrics(time, lhand_pose, rhand_pose, hand_pose, tgoal_pose, tactual_pose, status):
    if _DATA_LOGGER.running:
        ...
        new_data = [time, lhand_pose_arr, rhand_pose_arr, hand_pose_arr, tgoal_pose_arr, tactual_pose_arr, status_string]
        _DATA.put(new_data)
        # print new_data
    else:
        return
