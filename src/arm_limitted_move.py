...
def move_wrist(wrist_group):
  ...
  w: 0.602914318351
	...
	wrist1_pose = wrist_group.get_current_pose("wrist_1_link").pose
	print "wrist1_pose:", wrist1_pose  #  rosrun tf tf_echo /world /tool0
	random_pose = wrist_group.get_random_pose()
	wrist_group.set_pose_target(random_pose)
	
	wrist_group.go()
	
	# wrist3_pose = wrist_group.get_current_pose("wrist_3_link").pose
	# print "wrist3_pose:", wrist3_pose  #  rosrun tf tf_echo /world /tool0
